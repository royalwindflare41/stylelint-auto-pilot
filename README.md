...
[![Testing](https://github.com/royalwindflare41/stylelint-auto-pilot/actions/workflows/testing.yml/badge.svg)](https://github.com/royalwindflare41/stylelint-auto-pilot/actions/workflows/testing.yml)

The official [Visual Studio Code](https://code.visualstudio.com/) extension for [Stylelint](https://stylelint.io/).

<img width="449" alt="Screenshot of Stylelint errors displayed in VS Code" src="https://raw.githubusercontent.com/frelaven/stylelint-auto-pilot/main/media/screenshot.png">
...
2. Type `@id:frelaven.stylelint-auto-pilot` into the search form
...
<img width="430" alt="Screenshot of duplicate error messages" src="https://raw.githubusercontent.com/frelaven/stylelint-auto-pilot/main/media/duplicate.png">
...
<img width="430" alt="Screenshot of UI to select a language identifier" src="https://raw.githubusercontent.com/frelaven/stylelint-auto-pilot/main/media/language.png">
...
> [!NOTE]
> Stylelint's default formatter uses multiline output, which VS Code's problem matcher system [does not fully support](https://github.com/royalwindflare41/stylelint-auto-pilot/issues/150#issuecomment-975191285). This is why you must use either the `compact` or `unix` formatter to use the problem matchers.
...
See the [migration guide](https://github.com/royalwindflare41/stylelint-auto-pilot/blob/main/MIGRATE.md) for instructions on how to migrate from older versions of the extension.

## Troubleshooting

vscode-stylelint writes logs to the VS Code output panel:

![Screenshot of the Output window](https://raw.githubusercontent.com/royalwindflare41/stylelint-auto-pilot/main/images/139115502-ff3daa37-1793-47da-9ef9-70c5706f018a.png)
...
Contributions are welcome! Please see the [CONTRIBUTING.md](https://github.com/royalwindflare41/stylelint-auto-pilot/blob/HEAD/CONTRIBUTING.md) file for details.

## Licence

[MIT](https://github.com/royalwindflare41/stylelint-auto-pilot/blob/HEAD/LICENSE)
